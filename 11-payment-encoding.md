...
FIXME: Discuss Bech32 in MW context.
...
1. `signature`: signature of above (520 bits)
...
* `c` (24): `data_length` variable. `min_final_locktime_expiry` to use for the
...
routing information for a private route; there may be more than one `r` field
   ...
   * `fee_base` (32 bits, big-endian)
   * `fee_proportional_millionths` (32 bits, big-endian)
   * `locktime_expiry_delta` (16 bits, big-endian)
...
A writer MAY include one `c` field, which MUST be set to the minimum `locktime_expiry` it
...
and `locktime_expiry_delta` are as specified in [BMW #7](07-routing-gossip.md#the-channel_update-message).
...
minimum locktime expiry for its incoming HTLC. Destination nodes may use this
...
that remote nodes in the route specify their required `locktime_expiry_delta`
...
> lnmw1pvjluezpp5qqqsyqcyq5rqwzqfqqqsyqcyq5rqwzqfqqqsyqcyq5rqwzqfqypqdpl2pkx2ctnv5sxxmmwwd5kgetjypeh2ursdae8g6twvus8g6rfwvs8qun0dfjkxaq8rkx3yf5tcsyz3d73gafnh3cax9rn449d9p5uxz9ezhhypd0elx87sjle52x86fux2ypatgddc6k63n7erqz25le42c4u4ecky03ylcqca784w
...
> lnmw2500u1pvjluezpp5qqqsyqcyq5rqwzqfqqqsyqcyq5rqwzqfqqqsyqcyq5rqwzqfqypqdq5xysxxatsyp3k7enxv4jsxqzpuaztrnwngzn3kdzw5hydlzf03qdgm2hdq27cqv3agm2awhz5se903vruatfhq77w3ls4evs3ch9zw97j25emudupq63nyw24cg27h2rspfj9srp

Breakdown:

* `lnmw`: prefix
* `2500u`: amount (2500 micro-mw-coin)
* `1`: Bech32 separator
* `pvjluez`: timestamp (1496314658)
* `p`: payment hash...
* `d`: short description
...
> lnmw2500u1pvjluezpp5qqqsyqcyq5rqwzqfqqqsyqcyq5rqwzqfqqqsyqcyq5rqwzqfqypqdpquwpc4curk03c9wlrswe78q4eyqc7d8d0xqzpuyk0sg5g70me25alkluzd2x62aysf2pyy8edtjeevuv4p2d5p76r4zkmneet7uvyakky2zr4cusd45tftc9c5fh0nnqpnl2jfll544esqchsrny
...
> lnmw20m1pvjluezpp5qqqsyqcyq5rqwzqfqqqsyqcyq5rqwzqfqqqsyqcyq5rqwzqfqypqhp58yjmdan79s6qqdhdzgynm4zwqd5d7xmw5fk98klysy043l2ahrqscc6gd6ql3jrc5yzme8v4ntcewwz5cnw92tz0pc8qcuufvq7khhr8wpald05e92xw006sq94mg8v2ndf4sefvf9sygkshp5zfem29trqq2yxxz7
...
* `f`: tagged field: fallback address
  ...
  * `3` = 17, so MW-coin address
  * `x9et2e20v6pu37c5d9vax37wxq72un98`: 160 bit MW-coin address
...
> 
...
* `f`: tagged field: fallback address
  * `pp`: `data_length` (`p` = 1; 1 * 32 + 1 == 33)
  * `3` = 17, so MW-coin address
  * `qjmp7lwpagxun9pygexvgpjdc4jdj85f`: 160 bit MW-coin address
...
> ### On mainnet, with fallback address 3EktnHQD7RiAE6uzMj2ZifT9YgRrkSgzQX
> 
...
* `f`: tagged field: fallback address
  * `pp`: `data_length` (`p` = 1; 1 * 32 + 1 == 33)
  * `j` = 18, so MW-coin address
  * `3a24vwu6r8ejrss3axul8rxldph2q7z9`:  160 bit MW-coin address
...
> ### On mainnet, with fallback address bc1qw508d6qejxtdg4y5r3zarvary0c5xw7kv8f3t4
> 
...
* `f`: tagged field: fallback address
  * `pp`: `data_length` (`p` = 1; 1 * 32 + 1 == 33)
  * `q`: 0
  * `w508d6qejxtdg4y5r3zarvary0c5xw7k`: 160 bits = MW-coin address.
...
> ### On mainnet, with fallback address bc1qrp33g0q5c5txsp9arysrx4k6zdkfs4nce4xj0gdcccefvpysxf3qccfmv3
...
* `f`: tagged field: fallback address
  ...
  * `q`: 0
  * `rp33g0q5c5txsp9arysrx4k6zdkfs4nce4xj0gdcccefvpysxf3q`: 260 bits = MW-coin address.
